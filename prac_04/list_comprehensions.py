...
names_longer_than_eleven_characters = [name.split()[1] for name in full_names if len(name) > 11]
names_longer_than_eleven_characters = (", ".join(names_longer_than_eleven_characters))
